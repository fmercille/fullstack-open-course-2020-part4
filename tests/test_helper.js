...
const initialBlogs = [
  ...
  { _id: '5a422ba71b54a676234d17fb', title: 'TDD harms architecture', author: 'Robert C. Martin', likes: 0, url: 'http://blog.cleancoder.com/uncle-bob/2017/03/03/TDD-Harms-Architecture.html', 'user': '5a422a851b54a006234d17f3', __v: 0 },
  { _id: '5a422bc61b54a676234d17fc', title: 'Type wars', author: 'Robert C. Martin', likes: 2, url: 'http://blog.cleancoder.com/uncle-bob/2016/05/01/TypeWars.html', 'user': '5a422a851b54a006234d17f3', __v: 0 }
]
...
const initialUsers = [
  ...
  { _id: '5a422a851b54a006234d17f2', username: 'foobar1', name: 'Test User1', passwordHash: '$2b$10$apPRAFB4nmVYzwv0hy11C.KHl3EPl1Fo9HS3dIqklTcttew36R20G', blogs: [] }, // password: password1
  { _id: '5a422a851b54a006234d17f3', username: 'foobar2', name: 'Test User2', passwordHash: '$2b$10$BukyPCpuDMzLB6hPk9zqre8pV4NXDdcCCt6J392u8NyOYHZjFDXQS', blogs: ['5a422a851b54a676234d17f7', '5a422aa71b54a676234d17f8', '5a422b891b54a676234d17fa', '5a422ba71b54a676234d17fb', '5a422bc61b54a676234d17fc', '5a422a851b54a676234d17fc'] }, // password: password2
